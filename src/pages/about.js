...
export default function AboutPage() {
    return html`
        ...
        <p>
            Furthermore, a few tasks around homeserver administration are supported, like listing media files in unencrypted rooms. The majority of features use the standardized <${ExternalLink} href="https://spec.matrix.org/">Matrix protocol</>. If a feature makes use of the Synapse Admin API, this is noted.
        </p>
        <h2>Identities</h2>
        <p>
        ...
        <p>
            No information about your homeserver or actions is sent to the developer or host of this web application. Identities are optionally stored in your browser's <${ExternalLink} href="https://developer.mozilla.org//docs/Web/API/Window/localStorage">localStorage</>. To eliminate the risk of a malicious release which could compromise your Matrix access tokens, download the application's source code and host it on a static HTTP(S) server.
        </p>
        <p>
            Matrix Wrench is my hobby project without a security audit or peer review. I use it at work and try to apply some best practices from my professional work to the development, however, Matrix Wrench is neither backed nor endorsed by my employer. There are a few unit tests that are automatically run on every commit. The project's dependencies are currently limited to <${ExternalLink} href="https://www.npmjs.com/package/htm">htm</> for rendering the interface.
        </p>
        <h2>Development</h2>
        <p>Found a bug? Want a feature? Please use the <${ExternalLink} href="https://gitlab.com/jaller94/matrix-wrench/-/issues">issue tracker on Gitlab.com</>.</p>
        <ul>
            <li>Code: <${ExternalLink} href="https://gitlab.com/jaller94/matrix-wrench">Matrix Wrench on Gitlab.com</></li>
            <li>License: <${ExternalLink} href="https://choosealicense.com/licenses/apache-2.0/">Apache 2.0</></li>
            <li>Author: <${ExternalLink} href="https://chrpaul.de/about">Christian Paul</></li>
        </ul>
    `;
}
