...
export default function AboutPage() {
    return html`
        ...
        <p>
            Matrix Wrench is my hobby project without a security audit or peer review. I use it at work and try to apply some best practices from my professional work to the development, however, Matrix Wrench is neither backed nor endorsed by my employer. There are a few unit tests that are automatically run on every commit. The project's dependencies are currently limited to <${ExternalLink} href="https://www.npmjs.com/package/htm">htm</a> for rendering the interface.
        </p>
        <h2>Development</h2>
        <p>Found a bug? Want a feature? Please use the <${ExternalLink} href="https://gitlab.com/jaller94/matrix-wrench/-/issues">issue tracker on Gitlab.com</a>.</p>
        <ul>
            <li>Code: <${ExternalLink} href="https://gitlab.com/jaller94/matrix-wrench">Matrix Wrench on Gitlab.com</a></li>
            <li>License: <${ExternalLink} href="https://choosealicense.com/licenses/apache-2.0/">Apache 2.0</a></li>
            <li>Author: <${ExternalLink} href="https://chrpaul.de/about">Christian Paul</a></li>
        </ul>
    `;
}
